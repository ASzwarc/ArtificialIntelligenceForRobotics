...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    def create_measurement_constraint(point):
    ...
    def create_measurement_constraint_value(point):
        constraint_value = matrix()
        constraint_value.zero(size_x, 1)
        point_idx = point * 2
        for landmark in data[point][0]:
...
test_data2 = [[[[0, 26.543274387283322, -6.262538160312672], [3, 9.937396825799755, -9.128540360867689]], [18.92765331253674, -6.460955043986683]],
              ...
              [[[3, 27.18579315312821, 8.067219022708391]], [-6.595520680493778, -18.88118393939265]], [[], [11.492663265706092, 16.36822198838621]], 
...
# result = slam(test_data2, 19, 5, 2.0, 2.0)
